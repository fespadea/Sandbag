...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_swish_heavy"));
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX_FRAME, get_window_value(AT_DSTRONG, 1, AG_WINDOW_LENGTH) - 1);
