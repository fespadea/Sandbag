...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_swish_heavy2"));
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX_FRAME, get_window_value(AT_FSTRONG, 1, AG_WINDOW_LENGTH) - 1);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_Y, -2);
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_GROUP, 1);

set_hitbox_value(AT_FSTRONG, 2, HG_PARENT_HITBOX, 1);
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FSTRONG, 2, HG_WINDOW, 4);
set_hitbox_value(AT_FSTRONG, 2, HG_LIFETIME, get_window_value(AT_FSTRONG, 4, AG_WINDOW_LENGTH));
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_X, 15);
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_Y, -2);
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_GROUP, 1);
