...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_CUSTOM_GRAVITY, gravity_speed/3);

set_window_value(AT_USPECIAL, 3, AG_WINDOW_LENGTH, 4);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_ANIM_FRAME_START, 12);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_CUSTOM_GRAVITY, gravity_speed/3);
...
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ell_uspecial_explode"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_LIFETIME, get_window_value(AT_USPECIAL, 6, AG_WINDOW_LENGTH));
